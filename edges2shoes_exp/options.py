...
class TrainOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str,
                                 default='../../checkpoints/augmented_cyclegan/models/',
        ...
        self.parser.add_argument('--numpy_data', type=int, choices=[0, 1], default=0,
                                 help='use numpy data instead of default JPEG images')
        ...
        self.parser.add_argument('--gpu_ids', type=str, default='2,3',
                                 help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')

        # supervised training
        self.parser.add_argument('--supervised', action='store_false',
                                 help='fraction of training data for supervised training')
        self.parser.add_argument('--sup_frac', type=float, default=0.1,
                                 help='fraction of training data for supervised training')
        self.parser.add_argument('--lambda_sup_A', type=float, default=0.1,
                                 help='weight for supervised loss (B -> A)')
        self.parser.add_argument('--lambda_sup_B', type=float, default=0.1,
                                 help='weight for supervised loss (A -> B)')
        ...
        self.parser.add_argument('--niter', type=int, default=25,
        ...
        self.parser.add_argument('--z_gan', type=int, default=1, choices=[0, 1],
                                 help='use a GAN on z_B')
        ...
        self.parser.add_argument('--num_multi', type=int, default=10,
                                 help='the number of z_B used to generate different B')
        self.parser.add_argument('--eval_A_freq', type=int, default=1,
                                 help='frequency of evaluating on A')
        self.parser.add_argument('--eval_B_freq', type=int, default=1,
                                 help='frequency of evaluating on B')
...
class TestOptions(object):
    def __init__(self):
        ...
        self.parser.add_argument('--train_logvar', type=int, default=1,
                                 help='train logvar_B on training data')
        self.parser.add_argument('--dataroot', required=True, type=str, help='path to images')
        self.parser.add_argument('--metric', required=True, type=str,
                                 choices=['bpp', 'mse', 'visual', 'noise_sens'])
