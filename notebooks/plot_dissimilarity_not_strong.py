...
path_to_outdoor = os.path.join(path_to_data, "outdoor_128.hdf5")
path_to_church = os.path.join(path_to_data, "church_128.hdf5")
path_to_dtd = os.path.join(path_to_data, "dtd/images")
path_to_anime = os.path.join(path_to_data, "aligned_anime_faces")

path_to_celeba = "/gpfs/gpfs0/optimaltransport-lab/datasets/celeba/img_align_celeba"
...
# DATASET1, DATASET1_PATH = 'outdoor', path_to_outdoor
# DATASET2, DATASET2_PATH = 'church', path_to_church

# DATASET1, DATASET1_PATH = 'outdoor', '../../data/outdoor_128.hdf5'
# DATASET2, DATASET2_PATH = 'church', '../../data/church_128.hdf5'

DATASET1, DATASET1_PATH = 'celeba_female', path_to_celeba
DATASET2, DATASET2_PATH = 'aligned_anime_faces', path_to_anime
...
X_test_fixed_2 = X_test_fixed[:4]

with torch.no_grad():
    T_X = T(X_test_fixed_2)
...
fig, axes = plt.subplots(2, num_examples, figsize=(11, 13), dpi=100)
...
for j in range(4):
    cur_img = T_X[j].permute(1, 2, 0).add(1).mul(0.5).cpu().numpy().clip(0,1).reshape(128, 128, 3)

    axes[1][j].imshow((cur_img * 255).astype(np.uint8))
...
plt.savefig(f"plot_not_strong_{DATASET1}2{DATASET2}_128.png")
...
# ax.axis('off')
# plt.tight_layout()
# plt.savefig("input_not_strong_{DATASET1}2{DATASET2}_128.png")
# plt.show()
...
# ax.axis('off')
# plt.tight_layout()
# plt.savefig("output_img_not_strong_{DATASET1}2{DATASET2}_128.png")
# plt.show()
...
# # plt.ylabel('Y Index')
# plt.tight_layout()
# plt.savefig("difference_heatmap_not_strong_{DATASET1}2{DATASET2}_128.png")
# plt.show()
