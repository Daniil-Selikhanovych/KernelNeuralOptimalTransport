...
path_to_celeba = "/trinity/home/daniil.selikhanovych/data/img_align_celeba_all"
...
DATASET1, DATASET1_PATH = 'celeba_male', path_to_celeba
DATASET2, DATASET2_PATH = 'celeba_female', path_to_celeba
...
fig.savefig("male_to_female_64.png")
fig.show()
