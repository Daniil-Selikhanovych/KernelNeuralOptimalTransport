...
# DATASET1, DATASET1_PATH = 'celeba_female', './data/image_align_celeba'
...
# path_to_save = "/mnt/sdb1/home/selikhanovych/OT_competitors/stargan-v2/data"
...
sexes = ["celeba_female", "celeba_female", "aligned_anime_faces", "aligned_anime_faces"]
...
for i in range(4):
    ...
    index = 0
    path_to_folder = os.path.join(path_to_save, f"celeba2anime_{mode}", sex, sex)
